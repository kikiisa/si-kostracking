                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ Route('registrasi.store') }}" method="post">
                            ...
                            <div class="form-group">
                                <label class="mb-2 mt-2" for=""><strong>Nama Lengkap</strong></label>
                            ...
                            <div class="form-group">
                                <label class="mb-2 mt-2" for=""><strong>Email</strong></label>
                            ...
                            <div class="form-group">
                                <label class="mb-2 mt-2" for=""><strong>Phone</strong></label>
                            ...
                            <div class="form-group">
                                <label class="mb-2 mt-2" for=""><strong>Password</strong></label>
                            ...
                            <div class="form-group">
                                <label class="mb-2 mt-2" for=""><strong>Konfirmasi Password</strong></label>
